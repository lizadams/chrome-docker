...
[x] I added csh to the list of items to be installed on the container, to allow us to run verdi scripts.

[x] It may be helpful to add csh to the list of available shells in the list of fluxbox shells. Automatically added once csh was available.

[ ] I need to check and see if this will trigger a rebuild of the container on docker hub.

[ ] Need to test running container on Amazon AWS and connecting to IP address instead of localhost.
